...
public class Lion extends Fighter 
{
	float hitTimer;
	int i,j;
	...
	public Lion(String team, float x, float y) {
		super(team, x, y);
		rect.set(x-96/2,y,96,96);
	}
	...
	public void draw(SpriteBatch batch) {
		...
		batch.draw(texReg[i][j],x-96/2,y,96/2,0,96,96,lookingLeft?-1:1,1,0);
		if(hitTimer>0){
